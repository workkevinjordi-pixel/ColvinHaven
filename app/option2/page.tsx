...
function MiniNav({ className }: { className?: string }) {
  return (
    ...
    <main className="opt2">
      ...
      <header className="opt2-hero">
        <Image
          ...
          sizes="100vw"
        />
        <div className="opt2-hero__overlay" />
      ...
      <section className="opt2-section opt2-philosophy">
        ...
        <div className="opt2-prose opt2-prose--center">
          ...
          <p>
            Nature, close enough to touch. No sound that doesn&rsquo;t belong
            here — water, wind, birdsong, and nothing manufactured underneath
            it. Timber and stone chosen not for how they photograph, but for how
            they feel under a hand — warm, familiar, closer to a held object
            than a building material. A wellness practice waiting whenever you
            want it, or none of it at all — a chair, good light, a book, and
      ...
      <section className="opt2-section opt2-inspiration">
        <div className="opt2-eyebrow-block">
          ...
          <h2 className="opt2-heading opt2-heading--wide">
            Nature never rushes. Limited edition homes, where silence is luxury.
          </h2>
        </div>
      ...
      <section id="editions" className="opt2-section opt2-editions">
        ...
        <p className="opt2-prose opt2-prose--center opt2-prose--tight">
          Colvin Haven doesn&rsquo;t design a home and then have it built. The
          two happen together, craftsman and founder, on site, for as long as
          each home takes. We offer a limited turnkey home to our clients.
        </p>
      ...
      <section id="collective" className="opt2-quotes">
        ...
        <div className="opt2-quotes__body">
          ...
          <img
            className="opt2-quotes__drawing"
          ...
          <p className="opt2-quotes__text">
            ...
            inside and outside dissolves entirely. It&rsquo;s the same core, in
            every CH home.&rdquo;
          </p>
        </div>
      </section>
